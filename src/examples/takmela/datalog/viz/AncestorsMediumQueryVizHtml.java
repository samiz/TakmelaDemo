...
public class AncestorsMediumQueryVizHtml
{
	...
	{
		String datalogProgramPath = "./takmelogic_examples/ancestors_medium_query_viz/ancestors.dlog";
		String query = "a";
		Object[] queryArgs = new Object[] {"b", null}; // null -> output parameter
		
		WebTraceConfiguration config = new WebTraceConfiguration();
		config.OutputPath = "./trace_html/datalog_examples/ancestors_medium_query/index.html";
		...
		config.TemplatePath = "./trace_templates/ancestors_medium_query.html";
